...
class AppointmentsTest(SupersaasTest):
    ...
    def test_get_appointment_id(self):
        ...
        self.assertIsNotNone(self.client.appointments.get(schedule_id, appointment_id))
    ...
    def test_update_all(self):
        appointment_id = 67890
        schedule_id = 12345
        self.assertIsNotNone(self.client.appointments.update(schedule_id, appointment_id, self.__appointment_attributes(), True, True))
    ...
    def test_agenda_all_params(self):
        schedule_id = 12345
        user_id = 67890
        self.assertIsNotNone(self.client.appointments.agenda(schedule_id, user_id, "2017-01-31 14:30:00", True))
    ...
    def test_agenda_slots_from_time(self):
        schedule_id = 12345
        user_id = 67890
        self.assertIsNotNone(self.client.appointments.agenda_slots(schedule_id, user_id, "2017-01-31 14:30:00"))
    ...
    def test_changes_all(self):
        schedule_id = 12345
        user_id = 67890
        self.assertIsNotNone(self.client.appointments.changes(schedule_id, "2017-01-31 14:30:00", "2017-01-31 15:30:00", True, user_id, 10, 10))
    ...
    def test_range_all(self):
        ...
        resource_id = 54321
        service_id = 876543
        self.assertIsNotNone(self.client.appointments.range(schedule_id, True, "2017-01-31 14:30:00", "2017-01-31 16:30:00", True, user_id, resource_id, service_id, 10, 10))
    ...
    def test_delete_all(self):
        schedule_id = 12345
        appointment_id = 67890
        self.assertIsNotNone(self.client.appointments.delete(schedule_id, appointment_id, True))
