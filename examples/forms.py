...
print("You will need to create a form, and also attach the form to a booking, see documentation on how to do that")
print("The below example will take a form in random, and if it is not attached to something then 404 error will be raised")

print("listing forms...")
print("#### SuperSaaSClient.instance().forms.forms")
...
if template_forms:
    ...
    print("#### SuperSaaSClient.instance().forms.list")
    form_id = choice(Client.instance().instance().forms.list(template_form_id)).id

    print("getting form...")
    print(f"#### SuperSaaSClient.instance().forms.get({form_id})")
